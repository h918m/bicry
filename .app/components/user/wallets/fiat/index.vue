        ...
        <div class="grid gap-5 grid-cols-12">
          <BaseCard class="overflow-hidden p-6 col-span-12 lg:col-span-8">
            <div class="mb-12 flex items-center justify-between">
              ...
              <div class="flex gap-2 xs:flex-col sm:flex-row">
                <BaseButton
            ...
            <div class="flex flex-col gap-y-4 sm:flex-row sm:gap-x-8">
              ...
              <div
                class="slimscroll grid pr-2 grid-cols-1 w-full xs:max-h-[200px] md:max-h-[164px] gap-4 overflow-y-auto sm:grid-cols-2"
              >
                <UserWalletFiatCard
