    ...
    <div class="ltablet:col-span-8 col-span-12 lg:col-span-8">
      <div class="flex flex-col gap-6">
        ...
        <div class="col-span-12">
          <div
            class="bg-primary-800 flex flex-col items-center rounded-2xl p-4 sm:flex-row w-full mb-8"
          >
            <div
              class="relative w-[320px]"
              :class="{
                'h-[170px] mb-16': $viewport.isLessThan('sm'),
          ...
          <div class="mb-14">
            ...
            >
              <Slide v-for="(category, index) in categories" :key="index">
                <NuxtLink
                  class="group relative flex w-full flex-col border overflow-hidden rounded-3xl cursor-pointer"
                ...
                >
                  <img
                    class="h-48 w-full object-cover object-center rounded-2xl transition-all duration-300 ease-in-out group-hover:scale-105"
          ...
          <div class="grid gap-x-3 gap-y-6 sm:grid-cols-3">
            ...
            <template v-if="activeCategory">
              ...
              >
                <BaseCard
                  shape="curved"
                  class="hover:border-primary-500 hover:shadow-muted-300/30 dark:hover:shadow-muted-900/40 p-3 hover:shadow-xl group"
                >
                  <div
                    class="ltablet:h-48 bg-muted-100 dark:bg-muted-900 relative mb-3 h-48 w-full rounded-xl sm:h-32 md:h-48"
                  >
                    <img
                      class="absolute inset-0 h-full w-full object-cover rounded-xl border border-transparent transition-all duration-300 ease-in-out group-hover:scale-105 group-hover:-translate-y-1"
