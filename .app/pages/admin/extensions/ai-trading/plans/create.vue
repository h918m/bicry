...
definePageMeta({
  title: 'Create AI Trading Investment Plans',
  permissions: ['Create AI Trading Plans'],
})
...
const { createAITradingPlan } = useAiTrading()
...
const create = handleSubmit(async (values: FormInput) => {
  try {
    ...
    const response = await createAITradingPlan(data)
