  ...
  <div class="inline-flex w-full flex-col md:flex-row md:justify-between">
    ...
    >
      ...
      <li>
        <NuxtLink
          :to="paginatedLink(1)"
          tabindex="0"
          class="flex h-6 w-6 items-center justify-center border font-sans text-xs transition-all duration-300"
          :class="[
            currentPage === 1
      ...
      <li v-if="showLastLink && pages.length > 0 && pages[0] > 2">
        <span
          class="border-muted-200 text-muted-500 dark:border-muted-700 dark:bg-muted-800 flex h-6 w-6 items-center justify-center bg-white font-sans text-xs"
          :class="[
            shape === 'rounded' && 'rounded-md',
            shape === 'curved' && 'rounded-xl',
            shape === 'full' && 'rounded-full',
      ...
      <li v-for="page in pages" :key="page">
        <NuxtLink
          ...
          class="flex h-6 w-6 items-center justify-center font-sans text-xs transition-all duration-300"
          :class="[
            currentPage === page
              ? 'bg-primary-500 border-primary-500 shadow-primary-500/50 dark:shadow-primary-500/20 text-white shadow-sm'
              : 'dark:bg-muted-800 border-muted-200 dark:border-muted-700 hover:bg-muted-100 dark:hover:bg-muted-900 text-muted-500 hover:text-muted-700 dark:hover:text-muted-400 bg-white',
    ...
    >
      ...
      <NuxtLink
        ...
        tabindex="0"
        class="border-muted-200 text-muted-500 hover:bg-muted-100 hover:text-muted-700 dark:border-muted-700 dark:bg-muted-800 dark:hover:bg-muted-900 dark:hover:text-muted-400 flex h-6 w-full items-center justify-center bg-white font-sans text-xs transition-all duration-300 md:w-6"
        :class="[
          shape === 'rounded' && 'rounded-md',
          shape === 'curved' && 'rounded-xl',
          shape === 'full' && 'rounded-full',
